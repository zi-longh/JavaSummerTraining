...
CREATE TABLE `t_goods`  (
  `goodsNum` int NOT NULL AUTO_INCREMENT COMMENT '商品编号',
  ...
  `goodsPrice` double NULL DEFAULT NULL COMMENT '售价',
  `goodsCost` double NULL DEFAULT NULL COMMENT '成本',
